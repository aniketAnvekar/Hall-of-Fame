...
# use this in add_video.html incase of formset{{ formset.management_form }}
# {{ for f in form }}   ....    {{ endfor }}

YOUTUBE_API_KEY = 'AIzaSyBGFHpvnRvKmFwZbQWW80elw5pUyZzy3_g'
...
def add_video(request,pk):
    ...
    return render(request,'add_video.html',{'form':form,'search_form':searchform,'hall':hall})
